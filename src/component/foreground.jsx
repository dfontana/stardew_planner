...
class Foreground extends Component {
  ...
  drawBoundaries = (canvas) => {
    ...
    p2.lineTo(scrn(39), scrn(7))
    p2.lineTo(scrn(47), scrn(7))
    p2.lineTo(scrn(47), scrn(8))
    p2.lineTo(scrn(52), scrn(8))
    p2.lineTo(scrn(52), scrn(6))
    p2.lineTo(scrn(57), scrn(6))
    p2.lineTo(scrn(57), scrn(7))
    p2.lineTo(scrn(58), scrn(7))
    p2.lineTo(scrn(58), scrn(8))
    p2.lineTo(scrn(59), scrn(8))
    p2.lineTo(scrn(59), scrn(9))
    // --- (Behind upper fence, not sure)
    p2.lineTo(scrn(68), scrn(9))
    p2.lineTo(scrn(68), scrn(7))
    p2.lineTo(scrn(69), scrn(7))
    p2.lineTo(scrn(69), scrn(6))
    p2.lineTo(scrn(76), scrn(6))
    p2.lineTo(scrn(76), scrn(8))
    p2.lineTo(scrn(70), scrn(8))
    p2.lineTo(scrn(70), scrn(11))
    // ---
    p2.lineTo(scrn(79), scrn(11))
    p2.lineTo(scrn(79), scrn(16))
    p2.lineTo(scrn(81), scrn(16))
    p2.lineTo(scrn(81), scrn(20))
    p2.lineTo(scrn(78), scrn(20))
    p2.lineTo(scrn(78), scrn(29))
    p2.lineTo(scrn(68), scrn(29))
    p2.lineTo(scrn(68), scrn(32))
    p2.lineTo(scrn(64), scrn(32))
    p2.lineTo(scrn(64), scrn(29))
    p2.lineTo(scrn(60), scrn(29))
    p2.lineTo(scrn(60), scrn(28))
    p2.lineTo(scrn(59), scrn(28))
    p2.lineTo(scrn(59), scrn(27))
    p2.lineTo(scrn(58), scrn(27))
    p2.lineTo(scrn(58), scrn(25))
    p2.lineTo(scrn(57), scrn(25))
    p2.lineTo(scrn(57), scrn(24))
    p2.lineTo(scrn(55), scrn(24))
    p2.lineTo(scrn(55), scrn(23))
    p2.lineTo(scrn(52), scrn(23))
    p2.lineTo(scrn(52), scrn(24))
    p2.lineTo(scrn(50), scrn(24))
    p2.lineTo(scrn(50), scrn(25))
    p2.lineTo(scrn(49), scrn(25))
    p2.lineTo(scrn(49), scrn(29))
    p2.lineTo(scrn(48), scrn(29))
    p2.lineTo(scrn(48), scrn(30))
    p2.lineTo(scrn(41), scrn(30))
    p2.lineTo(scrn(41), scrn(29))
    p2.lineTo(scrn(35), scrn(29))
    p2.lineTo(scrn(35), scrn(26))
    p2.lineTo(scrn(33), scrn(26))
    p2.lineTo(scrn(33), scrn(25))
    p2.lineTo(scrn(30), scrn(25))
    p2.lineTo(scrn(30), scrn(24))
    p2.lineTo(scrn(23), scrn(24))
    p2.lineTo(scrn(23), scrn(23))
    p2.lineTo(scrn(22), scrn(23))
    // --- (Omit GreenHouse)
    ...
    p2.moveTo(scrn(20), scrn(29))
    p2.lineTo(scrn(30), scrn(29))
    p2.lineTo(scrn(30), scrn(30))
    p2.lineTo(scrn(31), scrn(30))
    p2.lineTo(scrn(31), scrn(31))
    p2.lineTo(scrn(32), scrn(31))
    p2.lineTo(scrn(32), scrn(36))
    p2.lineTo(scrn(31), scrn(36))
    p2.lineTo(scrn(31), scrn(37))
    p2.lineTo(scrn(30), scrn(37))
    p2.lineTo(scrn(30), scrn(38))
    p2.lineTo(scrn(20), scrn(38))
    p2.lineTo(scrn(20), scrn(37))
    p2.lineTo(scrn(19), scrn(37))
    p2.lineTo(scrn(19), scrn(36))
    p2.lineTo(scrn(18), scrn(36))
    p2.lineTo(scrn(18), scrn(31))
    p2.lineTo(scrn(19), scrn(31))
    p2.lineTo(scrn(19), scrn(30))
    p2.lineTo(scrn(20), scrn(30))
    p2.lineTo(scrn(20), scrn(29))
    
    // Right island below farmhouse
    p2.moveTo(scrn(64), scrn(37))
    p2.lineTo(scrn(68), scrn(37))
    p2.lineTo(scrn(68), scrn(38))
    p2.lineTo(scrn(70), scrn(38))
    p2.lineTo(scrn(70), scrn(41))
    p2.lineTo(scrn(73), scrn(41))
    p2.lineTo(scrn(73), scrn(42))
    p2.lineTo(scrn(74), scrn(42))
    p2.lineTo(scrn(74), scrn(43))
    p2.lineTo(scrn(75), scrn(43))
    p2.lineTo(scrn(75), scrn(48))
    p2.lineTo(scrn(74), scrn(48))
    p2.lineTo(scrn(74), scrn(49))
    p2.lineTo(scrn(73), scrn(49))
    p2.lineTo(scrn(73), scrn(50))
    p2.lineTo(scrn(68), scrn(50))
    p2.lineTo(scrn(68), scrn(49))
    p2.lineTo(scrn(66), scrn(49))
    p2.lineTo(scrn(66), scrn(47))
    p2.lineTo(scrn(64), scrn(47))
    p2.lineTo(scrn(64), scrn(46))
    p2.lineTo(scrn(63), scrn(46))
    p2.lineTo(scrn(63), scrn(45))
    p2.lineTo(scrn(62), scrn(45))
    p2.lineTo(scrn(62), scrn(39))
    p2.lineTo(scrn(63), scrn(39))
    p2.lineTo(scrn(63), scrn(38))
    p2.lineTo(scrn(64), scrn(38))
    p2.lineTo(scrn(64), scrn(37))
